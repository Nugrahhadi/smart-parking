...
import { fetchUsers, formatDate } from "../utils/api";
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="flex h-full overflow-hidden">
          {/* Main User List */}
          <div
            className={`bg-white rounded-lg shadow-sm overflow-hidden m-4 ${
              showDetails ? "hidden md:block md:w-1/2 lg:w-2/3" : "w-full"
            }`}
          >
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden w-full md:w-1/2 lg:w-1/3 border-l">
              ...
              <div className="p-4">
                <div className="flex flex-col items-center mb-6">
                  ...
                  <p
                    className={`mt-1 text-sm px-2 py-0.5 rounded-full ${
                ...
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-medium">{selectedUser.id}</h4>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p>{renderStatusBadge(selectedUser.status || "active")}</p>
                  </div>
                  <div>
                ...
                <div className="border-b border-gray-200">
                  <nav className="-mb-px flex space-x-6">
                    <a
                      href="#"
                      className="border-b-2 border-blue-500 py-2 text-sm font-medium text-blue-600"
                    >
                      Transactions
                    </a>
                    <a
                      href="#"
                      className="border-b-2 border-transparent py-2 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700"
                    >
                      Vehicles
                    </a>
                    <a
                    ...
                    {transactionHistory.map((transaction) => (
                      ...
                      >
                        ...
                        <div className="mt-2 text-sm">
                          ...
                          <p>
                            Slot: {transaction.slot}, Duration:{" "}
                    ...
                    <div className="border border-gray-200 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Set user's system-wide permissions
                          </p>
                        </div>
