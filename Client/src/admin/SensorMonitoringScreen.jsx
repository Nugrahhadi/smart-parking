...
const SensorMonitoringScreen = () => {
  return (
    <div className="p-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-800">🎥 Sensor Monitoring</h1>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded max-w-2xl mx-auto text-left">
          <p className="text-sm text-blue-800">
            <span className="font-semibold">Status:</span> The camera integration module is in the planning phase.
            Once hardware cameras are connected to the system, this module will enable 
            live monitoring and automatic license plate detection for streamlined parking operations.
          </p>
        </div>
      </div>
    </div>
